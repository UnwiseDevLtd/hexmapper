// version check: compare against latest codeberg release (non-blocking)
(function(){
  var VER = (typeof VERSION !== "undefined") ? VERSION : "dev";
  if(VER === "dev") return;
  setTimeout(function(){
    fetch("https://codeberg.org/api/v1/repos/UnwiseDev/hexmapper/releases/latest")
      ...
      .then(function(d){
        if(d && d.tag_name && d.tag_name !== VER){
          ...
          n.onclick = function(){ window.open("https://codeberg.org/UnwiseDev/hexmapper/releases"); };
